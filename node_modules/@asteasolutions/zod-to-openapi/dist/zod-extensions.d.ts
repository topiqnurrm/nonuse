...
declare module 'zod' {
    interface ZodType<Output = unknown, Input = unknown> {
        openapi<T extends ZodType>(this: T, metadata: Partial<ZodOpenAPIMetadata<Input>>, options?: OpenApiOptions): T;
        openapi<T extends ZodType>(this: T, refId: string, metadata?: Partial<ZodOpenAPIMetadata<Input>>, options?: OpenApiOptions): T;
    }
}
